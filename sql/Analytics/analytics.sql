...
set @now = getdate()
set @start = '2010-01-01'--'2015-01-01'--'2016-01-01'--'2010-01-01'--dateadd(mm,(year(@now)- 1900) * 12 + month(@now) - 1 -1 , 0) 
set @end = '2014-12-31'--dateadd(d,-1 , dateadd(mm,(year(@now)- 1900) * 12 + month(@now)- 1 , 0))  
